...
const (
	...
	DecideUseRAGMessageRawInitialUserPromptV1 = `You are a chatbot assistant that will answer user questions based on the references provided.
In this session, you will provide true or false data.
Return true if you can answer directly without needing additional information; otherwise, return false.`

	DecideUseRAGMessageRawInitialModelPromptV1 = `Understood. I will respond with "True" only if I can definitively answer the user’s question
based solely on my existing knowledge and the provided references.
I will respond with "False" if I cannot.
I will not make assumptions, educated guesses, or provide potentially inaccurate information.
