...
type GeminiChatAppSchema struct {
	AnswerDirectly *GeminiChaPropertySchema `json:"answerDirectly"`
}
...
func DecideToUseRAG(ctx context.Context, apiKey string, chatHistories []*ChatHistory) (bool, error) {
	...
	payload := GeminiChatRequest{
		...
		GenerationConfig: &GeminiChatGenerationConfig{
			...
			ResponseSchema: &GeminiChatResponseSchema{
				Type:       "OBJECT",
				Properties: &GeminiChatAppSchema{AnswerDirectly: &GeminiChaPropertySchema{Type: "BOOLEAN"}},
